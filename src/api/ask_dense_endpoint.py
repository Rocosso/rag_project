...
async def ask_question_dense(
    ...
    '''
    **Technology** documents indexed using **all-mpnet-base-v2 embedings** and preproceded files by LDA and KMEANS clustering
